...
const run = async () => {
    // Just sync 2036-06-17 to have 1 slot booked (sisa 2)
    const { error } = await supabase.from('date_availability').upsert([{ date: '2036-06-17', slots_booked: 1, max_slots: 3, is_manually_closed: false }]);
    console.log("Fixed 2036-06-17:", error);
};
run();
